...
namespace GrainElevator.Storage.Migrations
{
    ...
    [Migration("20241029182936_addDeleteBehaviorCascadeForWarehouseEntities")]
    partial class addDeleteBehaviorCascadeForWarehouseEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.PriceListItem", b =>
                {
                    ...
                    b.Property<int>("ProductionPriceListId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ProductionPriceListId");
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.ProductionPriceList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.CompletionReport", b =>
                {
                    ...
                    b.HasOne("GrainElevatorAPI.Core.Models.ProductionPriceList", "PriceList")
                        .WithMany("CompletionReports")
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.OutputInvoice", b =>
                {
                    ...
                    b.HasOne("GrainElevatorAPI.Core.Models.WarehouseUnit", "WarehouseUnit")
                        .WithMany("OutputInvoices")
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.PriceListItem", b =>
                {
                    ...
                    b.HasOne("GrainElevatorAPI.Core.Models.ProductionPriceList", "ProductionPriceList")
                        .WithMany("PriceListItems")
                        .HasForeignKey("ProductionPriceListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ProductionPriceList");
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.ProductionBatch", b =>
                {
                    ...
                    b.HasOne("GrainElevatorAPI.Core.Models.InvoiceRegister", "Register")
                        .WithMany("ProductionBatches")
            ...
            modelBuilder.Entity("GrainElevatorAPI.Core.Models.WarehouseProductCategory", b =>
                {
                    b.HasOne("GrainElevatorAPI.Core.Models.Employee", "CreatedBy")
                        .WithMany("WarehouseProductCategories")
                        .HasForeignKey("CreatedById")
                        .OnDelete(DeleteBehavior.Restrict);
